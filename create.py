...
brands = "CREATE TABLE brands ( " \
         ...
         "rep_phone_no VARCHAR2(30) NOT NULL " \
         ");"
brands_pk = "CREATE SEQUENCE brand_pk START WITH 1;"
status = "CREATE TABLE statuses ( " \
         "status_id INTEGER PRIMARY KEY, " \
         "status_name VARCHAR2(30) NOT NULL" \
         ");"
status_pk = "CREATE SEQUENCE status_pk START WITH 1;"
...
size_pk = "CREATE SEQUENCE size_pk START WITH 1;"
...
flavouring = "CREATE TABLE flavour_ings ( " \
             ...
             ");"
flavouring_pk = "CREATE SEQUENCE fl_ig_pk START WITH 1;"
...
ord_prod = "CREATE TABLE order_products ( " \
           ...
           "FOREIGN KEY (product_id) REFERENCES products(product_id) " \
           ");"
ord_prod_pk = "CREATE SEQUENCE op_id START WITH 1;"

create_tables = [flavours, ingredients, brands, suppliers, customers, status, sizes, products, flavouring, favourites,
                 orders, ord_prod]
